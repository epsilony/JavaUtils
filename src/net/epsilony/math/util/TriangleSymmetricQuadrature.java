...
/**
 * <p> 对称三角形Gauss积分的工具类 </p>
 * <p> 采用sum(面积×权值×积分点被积函数值)的方法进行积分，积分点采用重心坐标为背景数据，积分点全在三角形的内部（边，与外部均无积分点），最高代数精度为{@link #MAX_POWER} </p>
...
//        {0.097135796282799, 0.031334700227139, 0.031334700227139, 0.031334700227139, 0.077827541004774, 0.077827541004774, 0.077827541004774, 0.079647738927210, 0.079647738927210, 0.079647738927210, 0.025577675658698, 0.025577675658698, 0.025577675658698, 0.043283539377289, 0.043283539377289, 0.043283539377289, 0.043283539377289, 0.043283539377289, 0.043283539377289}
    };
    public final static double[][] barycentricCoordinates = new double[][]{
        ...
        {0.873821971016996, 0.063089014491502, 0.063089014491502, 0.063089014491502, 0.873821971016996, 0.063089014491502, 0.063089014491502, 0.063089014491502, 0.873821971016996, 0.501426509658179, 0.249286745170910, 0.249286745170910, 0.249286745170910, 0.501426509658179, 0.249286745170910, 0.249286745170910, 0.249286745170910, 0.501426509658179, 0.636502499121399, 0.310352451033784, 0.053145049844817, 0.636502499121399, 0.053145049844817, 0.310352451033784, 0.310352451033784, 0.636502499121399, 0.053145049844817, 0.310352451033784, 0.053145049844817, 0.636502499121399, 0.053145049844817, 0.636502499121399, 0.310352451033784, 0.053145049844817, 0.310352451033784, 0.636502499121399},
        {1 / 3d, 1 / 3d, 1 / 3d, 0.479308067841920, 0.260345966079040, 0.260345966079040, 0.260345966079040, 0.479308067841920, 0.260345966079040, 0.260345966079040, 0.260345966079040, 0.479308067841920, 0.869739794195568, 0.065130102902216, 0.065130102902216, 0.065130102902216, 0.869739794195568, 0.065130102902216, 0.065130102902216, 0.065130102902216, 0.869739794195568, 0.638444188569810, 0.312865496004874, 0.048690315425316, 0.638444188569810, 0.048690315425316, 0.312865496004874, 0.312865496004874, 0.638444188569810, 0.048690315425316, 0.312865496004874, 0.048690315425316, 0.638444188569810, 0.048690315425316, 0.638444188569810, 0.312865496004874, 0.048690315425316, 0.312865496004874, 0.638444188569810},
        {1 / 3d, 1 / 3d, 1 / 3d, 0.081414823414554, 0.459292588292723, 0.459292588292723, 0.459292588292723, 0.081414823414554, 0.459292588292723, 0.459292588292723, 0.459292588292723, 0.081414823414554, 0.658861384496480, 0.170569307751760, 0.170569307751760, 0.170569307751760, 0.658861384496480, 0.170569307751760, 0.170569307751760, 0.170569307751760, 0.658861384496480, 0.898905543365938, 0.050547228317031, 0.050547228317031, 0.050547228317031, 0.898905543365938, 0.050547228317031, 0.050547228317031, 0.050547228317031, 0.898905543365938, 0.008394777409958, 0.263112829634638, 0.728492392955404, 0.008394777409958, 0.728492392955404, 0.263112829634638, 0.263112829634638, 0.008394777409958, 0.728492392955404, 0.263112829634638, 0.728492392955404, 0.008394777409958, 0.728492392955404, 0.008394777409958, 0.263112829634638, 0.728492392955404, 0.263112829634638, 0.008394777409958}
    };
     ...
     * @return 重心坐标数组，长度为3*{@link #getNumPoints(int) getNumPoints(power)},其内容为:</ br>
    ...
    /**
     * 获取power阶代数精度的三角形对称积分的积分点的重心坐标拷备
     * @param power 积分的代数精度 应属于闭区间[{@link #MIN_POWER},{@link #MAX_POWER}]
     * @return 重心坐标数组，长度为3*{@link #getNumPoints(int) getNumPoints(power)}
     */
    public static double[] getBarycentricCoordinates(int power) {
        return getBarycentricCoordinates(power, true);
    }
     ...
     * @param y3
     * @param power 积分的代数精度 应属于闭区间[{@link #MIN_POWER},{@link #MAX_POWER}]
     * @return 重心坐标数组，长度为2*{@link #getNumPoints(int) getNumPoints(power)}, ，其内容为{x<sub>积分点1</sub>,y<sub>积分点1</sub>,x<sub>积分点2</sub>,y<sub>积分点2</sub>,...,} 
     */
     ...
     * @deprecated 用{@link #quadrate(double, double, double, double, double, double, int, org.apache.commons.math.analysis.BivariateRealFunction) }代替
     */
