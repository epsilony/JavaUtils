...
public class TriangleSymmetricQuadrature {
    ...
    public final static int MAX_POWER=5;  // though the arrays weights and barycentricCoordinates have length 7 but the test case can only pass power 5, the reason may caused by the Simpson method or the test function.
    public final static int MIN_POWER=1;
    public final static int[] numPts = new int[]{1, 3, 4, 6, 7, 12, 13};
