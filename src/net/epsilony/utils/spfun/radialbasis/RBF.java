...
import net.epsilony.utils.spfun.DistanceSquareFunctionCore;
import net.epsilony.utils.spfun.InfluenceDomainSizer;
import net.epsilony.utils.spfun.DistanceSquareFunctionCores;
...
//    }
    ...
    public double[] values(Coordinate pt, double[] output) {
